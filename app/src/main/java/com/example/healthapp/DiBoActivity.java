...
public class DiBoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_di_bo);
...
//                        startService(serviceIntent);
        ...
        image_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DiBoActivity.this, MainActivity.class);
                startActivity(intent);
                finishAffinity();
            }
        });
        if(ActivityCompat.checkSelfPermission(DiBoActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
    ...
    private final ActivityResultLauncher<String> activityResultLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        ...
        public void onActivityResult(Boolean result) {
            if(result){
                Toast.makeText(DiBoActivity.this,"Cho phep", Toast.LENGTH_SHORT).show();
            }
            else{
                Toast.makeText(DiBoActivity.this,"Khong cho phep", Toast.LENGTH_SHORT).show();
            }
        }
    });
